...
const HeroText = (props: Props) => {
  ...
  return (
    <m.div
      ...
      // }}
      className={`${font2.variable} font-wdc3 flex flex-col md:flex-row xl:flex-row 2xl:flex-row  md:justify-center md:items-start xl:justify-between  w-full md:w-[65%] xl:w-[65%] 2xl:w-[65%]  m-auto flex-wrap relative`}
    >
